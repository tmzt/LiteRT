...
// chitin local fork: bumped from "0.10.2" so bindgen picks up the
// 6-arg `litert_lm_conversation_send_message_stream` signature (added
// in v0.13) plus the `litert_lm_conversation_optional_args_*` API that
// the v0.13 multimodal Gemma-4 models require (visual_token_budget).
